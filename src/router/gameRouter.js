...
router.post("/registergame",jwt_verification.jwt_verification, userMiddleware.verificantion_admin, imgupload.upload_game.single('image'), gameMiddleware.parameter_empty_check_register,gameMiddleware.duplicate_game, gameController.register_game);
...
router.put("/updategame",jwt_verification.jwt_verification, userMiddleware.verificantion_admin, imgupload.upload_game.single('image'), gameMiddleware.parameter_empty_check_register, gameController.update_game);
