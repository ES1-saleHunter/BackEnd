...
router.post("/registerstore",jwt_verification.jwt_verification, userMiddleware.verificantion_admin, imgupload.upload_store.single('image'), storeMiddleware.parameter_empty_check_register,storeMiddleware.duplicate_store, storeController.register_store);
...
router.put("/updatestore",jwt_verification.jwt_verification, userMiddleware.verificantion_admin, imgupload.upload_store.single('image'), storeMiddleware.parameter_empty_check_register, storeController.update_store);
